...
public class UserController {
    ...
    // @GetMapping(value = "/profile/{id}", produces =
    // MediaType.APPLICATION_JSON_VALUE)
    // @Operation(summary = "Find user profile", description = "Find user profile by
    // id", tags = {
    // "User" }, method = "GET")
    // @ApiResponses(value = {
    ...
    // @Content)
    // })
    // public ResponseEntity<UserDTO> findMe(@PathVariable UUID id) {
    // return ResponseEntity.ok(service.findMe());
    // }
