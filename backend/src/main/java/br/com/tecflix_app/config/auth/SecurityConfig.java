...
public class SecurityConfig {
  ...
  @Autowired
  public SecurityConfig(AuthenticationFilter authenticationFilter, SecurityFilter securityFilter) {
        ...
        .authorizeHttpRequests(
            authorize ->
                authorize
                    ...
                    // hello-world
                    .requestMatchers(HttpMethod.GET, "/hello-world")
                    .permitAll()
                    ...
                    // users
                    .requestMatchers(HttpMethod.GET, "/api/v1/users/find")
                    .permitAll()
